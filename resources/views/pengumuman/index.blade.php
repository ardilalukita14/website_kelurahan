                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="col-md-8">
                            <a href="{{route('pengumuman.create')}}" class="btn btn-info" style="margin-top:20px; margin-left:5px;">TAMBAH PENGUMUMAN</a>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <form action="{{ route('pengumuman.destroy',$data->id) }}" method="GET">
                                        ...
                                        <a class="btn btn-success" href="{{ route('pengumuman.edit',$data->id) }}">Edit</a>
