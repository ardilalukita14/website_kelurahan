                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="col-md-8">
                            <a href="{{route('visimisi.create')}}" class="btn btn-info" style="margin-top:20px; margin-left:5px;">TAMBAH VISI & MISI</a>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $data->judul }}</td>
                                        <td style=" padding: 30px;">{!! $data->visi !!}</td>
                                        <td style=" padding: 30px;">{!! $data->misi !!}</td>
                                        <td>
                                                
                                    <form action="{{ route('visimisi.destroy',$data->id) }}" method="GET">
                                        <a class="btn btn-info" href="{{ route('visimisi.show',$data->id) }}">Show</a>
                                        <a class="btn btn-success" href="{{ route('visimisi.edit',$data->id) }}">Edit</a>
