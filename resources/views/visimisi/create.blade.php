            ...
            <div class="col-md-8 offset-2 mt-5">
                <div class="card">
                    <div class="card-header bg-info">
                        <h6 class="text-white">TAMBAH DATA VISI & MISI</h6>
                    </div>
                    <div class="card-body">
                        <form method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="ckeditor form-control valid" name="visi"></textarea>
                            </div>

                            <div class="form-group">
                            <label><strong>Misi</strong></label>
                            <textarea class="ckeditor form-control valid" name="misi"></textarea>
                            </div>
