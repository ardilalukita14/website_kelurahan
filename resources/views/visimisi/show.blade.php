                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Detail Visi & Misi</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-center align-items-center">
                    <div class="card" style="width: 50rem; margin-left: 80px;">
                        <div class="card-header bg-info">
                            <h5 style="font-size: 18px; font-family: Arial, Helvetica"><b>Detail Data Visi & Misi</h5></b>
                        </div>
                        <div class="card-body">
                        ...
                        <a class="btn btn-success mt-3" href="{{ route('visimisi.index') }}" style="font-size: 16px; margin-bottom: 30px;">Kembali</a>
                    </div>
                </div>
            </div>
