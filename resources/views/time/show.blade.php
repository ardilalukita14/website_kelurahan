                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Detail Jam Pelayanan</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="container mt-5">
                <div class="row justify-content-center align-items-center">
                    <div class="card" style="width: 50rem; margin-left: 80px;">
                        ...
                        <a class="btn btn-success mt-3" href="{{ route('time.index') }}" style="font-size: 16px; margin-left:40px; margin-bottom: 30px;">Kembali</a>
                    </div>
                </div>
            </div>
