    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <div class="d-inline-block rounded-pill bg-secondary text-primary py-1 px-3 mb-3">Standar Pelayanan</div>
                <h1 class="display-6 mb-5">Standar dan Produk Layanan</h1>
            </div>
            <div class="position-relative mt-auto">
                <embed type="application/pdf" src="pdf/SK-Standar-Pelayanan-Kelurahan-6-komponen.pdf" width="1000" height="1200" style="margin-left: 150px"></embed>
            </div>
            <br>
        </div>
    </div>
