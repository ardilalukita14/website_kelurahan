    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <div class="d-inline-block rounded-pill bg-secondary text-primary py-1 px-3 mb-3">Tugas Pokok & Fungsi</div>
                <h1 class="display-6 mb-5">{{$all->judul}}</h1>
            </div>
            <div class="position-relative mt-auto">
                <img class="img-fluid" src="{{asset('foto/'.$all->foto)}}" style="height:400px; width:800px; display:block; margin:auto;" alt="">
            </div>
            <br></br>
            <p>{!!$all->isi!!}</p><br>
            <br>
