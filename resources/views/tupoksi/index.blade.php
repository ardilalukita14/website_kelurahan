                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="col-md-8">
                            <a href="{{route('tupoksi.create')}}" class="btn btn-info" style="margin-top:20px; margin-left:5px;">TAMBAH DATA TUPOKSI</a>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <form action="{{ route('tupoksi.destroy',$data->id) }}" method="GET">
                                        <a class="btn btn-info" href="{{ route('tupoksi.show',$data->id) }}">Show</a>
                                        <a class="btn btn-success" href="{{ route('tupoksi.edit',$data->id) }}">Edit</a>
