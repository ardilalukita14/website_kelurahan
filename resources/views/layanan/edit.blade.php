...
@section('content')
        ...
        <div class="breadcrumbs">
			...
			<div class="container mt-5" style="margin-right: 40px; background-color:#DCDCDC" >
			<form action="{{route('layanan.do_edit_layanan',$data->id)}}" method="post" style="margin-left: 20px;">
			{{csrf_field()}}
			<br></br>
			...
			<div class="form-group">
				<label>Masukkan Keterangan layanan</label>
