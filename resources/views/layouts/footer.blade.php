        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p>Website ini dikembangkan guna memberikan informasi secara meluas terkait Kelurahan Nambangan Kidul </p>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="position-relative mx-auto" style="max-width: 400px;">
                        <input class="form-control bg-transparent w-100 py-3 ps-4 pe-5" type="text" placeholder="Cari berita">
