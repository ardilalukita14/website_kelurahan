    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <h1 class="display-6 mb-5">Berita Pariwisata Kelurahan Nambangan Kidul</h1>
            </div>
            <div class="row g-4 justify-content-center">
            @foreach ($pariwisata as $pwst)
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="causes-item d-flex flex-column bg-white border-top border-5 border-primary rounded-top overflow-hidden h-100">
                        <div class="text-center p-4 pt-0">
                            ...
                            <h5 class="mb-3">{{substr($pwst->judul,0,50)}}...</h5>
                            <p>{!!substr($pwst->isi,0,80)!!}...</p>
                        </div>
                        <div class="position-relative mt-auto">
                            <img class="img-fluid" src="{{asset('foto/'.$pwst->foto)}}" style="height:250px; width:500px;" alt="">
                            <div class="causes-overlay">
                                <a class="btn btn-outline-primary" href="{{route('reader.show_news',$pwst->id)}}">
                                    Read More
